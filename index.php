        ...
        <article id="main">
            ...
            <section class="wrapper style1 container special">
                <div class="row">
                    ...
                    <div class="4u">                        <section>                            <span class="icon feature fa-picture-o"></span>
                            <header>
                                <h3>User - /<i>u</i>/n/w/h or /<i>u</i>/n/w</h3>
                            </header>
                            <p>Set the image <code>src</code> attribute to <code class="block">p-hold.com/u/name/w/h</code> to render a random image from the given user at the given dimensions.</p>                        </section>                    </div>                </div>                <div class="row">
                    <div class="4u">
                        <section>                            <span class="icon feature fa-picture-o"></span>
                            <header>
